...
module.exports = {
  ...
  devServer: {
    ...
    https: true,
    open: true,
    cert: fs.readFileSync(path.resolve(__dirname, 'certs', 'me.ryoikarashi.dev.crt')),
    key: fs.readFileSync(path.resolve(__dirname, 'certs', 'me.ryoikarashi.dev.key')),
  },
